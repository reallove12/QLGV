...
namespace QLGV
{
    partial class BaoCao
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.QLGVDataSet = new QLGV.QLGVDataSet();
            this.PhanCongBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.PhanCongTableAdapter = new QLGV.QLGVDataSetTableAdapters.PhanCongTableAdapter();
            ...
            reportDataSource1.Value = this.PhanCongBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "QLGV.Report1.rdlc";
            ...
            this.PhanCongBindingSource.DataSource = this.QLGVDataSet;
            // 
        ...
        private QLGVDataSetTableAdapters.PhanCongTableAdapter PhanCongTableAdapter;
    }
}